...
# BIT Full stack developer course – Part 7. Practice No.3: React kanban
...
This project is a part of my workbook from Full stack developers course at BIT This is the 7th part of the course. Pratcice No.3 React kanban

This project is for educational porpuses only. Pull request are welcome, but priority for project authors! Thank you for your cooperation!

View deployed result on [my github](https://madrakas.github.io/bit_07_03_homework_react_kanban/)
...
7. [React intro. Initialisation](https://github.com/madrakas/bit_07_react_intro)
    ...
    3. Practice No.3. React kanban (current repository)
8. 
